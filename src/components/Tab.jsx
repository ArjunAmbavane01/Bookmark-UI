...
const Tab1 = () => {
  ...
  <div className="mt-9">
    ...
    <div className="transition-colors duration-400 cursor-pointer mt-10 p-4 border-2 w-[125px] flex justify-center border-white rounded-lg bg-[#5368df] text-white hover:text-[#5368df] hover:bg-white hover:border-[#5368df]">More Info</div>
  </div>
  </>
}
